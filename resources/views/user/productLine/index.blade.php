					...
					<div class="col-12">
						<div class="hero owl-carousel" id="hero">
							...
							<div class="hero__slide">
								...
								<h1 class="hero__title">{{$product -> productLine}}</h1>
								<p class="hero__text">{{$product -> textDescription}}</p>
								<img style="margin-top:20px ;" src="/productlinesimage/{{$product -> image}}">
			...
			<section class="row row--grid">
				...
				<div class="col-12">
					<div class="main__title">
						<h2>Explore our Exclusive Toys</h2>
					</div>
				</div>
				<!-- end title -->
								...
								<div class="col-12 col-sm-6 col-lg-4 col-xl-3">
									...
									<div class="card">
										<a href="/productLine/specific/{{$categ->productCode}}" class="card__cover">
											<img src="/productlinesimage/{{$product -> image}}">
										</a>
										...
										<div class="main__carousel main__carousel--collections owl-carousel" id="collections">
											...
											<div class="collection">										
												...
												<div class="collection__meta">
													<h3 class="collection__name"> <a href="/productLine/productListperCateg/{{$product->productLine}}">{{$product -> productLine}}</a></h3>
													<span class="collection__number"> {{$product -> textDescription}}</span>
												</div>
											</div>@endforeach
										</div>
							...
							<div class="row row--grid">
								...
								<div class="col-12">
									<div class="main__title main__title--border-top">
										<h2>Learn More About our Store</h2>
									</div>
								</div>
								<!-- end title -->
								...
								<div class="col-12 col-md-6 col-lg-4 col-xl-3">
									<div class="feature">
										...
										<h3 class="feature__title">Authentic Products</h3>
										<p class="feature__text">All of the models we sell on our website are authentic and original. You can check it on the toy box and labels.</p>
									</div>
								</div>
								...
								<div class="col-12 col-md-6 col-lg-4 col-xl-3">
									<div class="feature">
										...
										<h3 class="feature__title">Latest News</h3>
										<p class="feature__text">Click here to know the latest news about car toys. <br><a href="{{ url('https://www.motor1.com/news/category/toys/') }}">Go to Website</a></p>
									</div>
								</div>
								...
								<div class="col-12 col-md-6 col-lg-4 col-xl-3">
									<div class="feature">
										...
										<h3 class="feature__title">Dfferent Categories</h3>
										<p class="feature__text">ENjoy browsing through the different toy categories we offer! Be sure to check each one and buy!</p>
									</div>
								</div>
								...
								<div class="col-12 col-md-6 col-lg-4 col-xl-3">
									<div class="feature feature--last">
										...
										<h3 class="feature__title">Product List and Descriptions</h3>
										<p class="feature__text">Know the characteristics and uniqueness of each car model by reading their specific description before buying.</p>
									</div>
								</div>
							</div>
							<!-- end get started -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="footer__content">
                ...
                <small class="footer__copyright">© Classic Models, 2022. Created by <a href="#" target="_blank">Baltazar-Bernabe-Handog-Lee-SanJose</a>.</small>
            </div>
        </div>
    </div>
</div>
