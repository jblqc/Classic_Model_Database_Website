...
<html lang="en">
	...
	<body>
		...
		<!-- main content -->
		<main class="main">
			<div class="main__author" data-bg="/productlinesimage/{{$categorySide -> image}}" style="margin-bottom: 50px;"></div>
				<div class="container">
					<div class="row row--grid">
						<div class="col-12 col-xl-3">
							<div class="author author--page">
								<div class="author__meta">
									<a href="#" class="collection__cover" data-bg="/productlinesimage/{{$categorySide -> image}}" style="margin-bottom: 20px;height: 200px;"></a>
									<h1 class="author__name"><a href="#">{{$categorySide -> productLine}}</a></h1>
									<p class="author__text">{{$categorySide -> textDescription}}</p>
								</div>
							</div>
						</div>
										...
										<div class="main__carousel main__carousel--collections owl-carousel" id="collections">
											@foreach ($categories as $categ)
												<div class="collection">
													<a href="/productLine/productListperCateg/{{$categ -> productLine}}" class="collection__cover" data-bg="/productlinesimage/{{$categ -> image}}"></a>
													<div class="collection__meta">
														<a href="/productLine/productListperCateg/{{$categ -> productLine}}" class="collection__avatar"></a>
								...
								<ul class="nav nav-tabs profile__tabs" id="profile__tabs" role="tablist">
									<li class="nav-item">
										<a class="nav-link active" data-toggle="tab" href="#tab-1" role="tab" aria-controls="tab-1" aria-selected="true">
											Category - {{$categorySide -> productLine}}
										</a>
									</li>
								</ul>
								<!-- end tabs nav -->
									...
									<div class="row row--grid">
										@foreach ( $products as $product )
											<div class="col-12 col-sm-6 col-lg-4">
												<!-- card -->										 
												<div class="card">
													<img src="/productsimage/{{$product -> image}}"  style="height: 300px;width: 260px;">
													<h3 class="card__title"><a href="/productLine/specific/{{$product->productCode}}">{{$product->productName}}</a></h3>
													<div class="card__author">
														<div class="row-ml-2">
															<p style="color: #fff;">{{$product->productCode}}</p>
															<p style="color:#bdbdbd;">{{$product->productVendor}}</p><br/><br/><br/>
														</div>
