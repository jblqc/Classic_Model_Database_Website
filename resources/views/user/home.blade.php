				...
				<section class="row row--grid">
					...
					<div class="col-12">
						<div class="main__title">
							<h2>Explore our Exclusive Models</h2>
						</div>
					</div>
					<!-- end title -->

					@include('user.usercontent')
					...
					<div class="row row--grid">
						...
						<div class="col-12 col-md-6 col-lg-4 col-xl-3">
							<div class="feature">
								<span><i style="color: #fff;" class="fa fa-check fa-2x"></i></span>
						...
						<div class="col-12 col-md-6 col-lg-4 col-xl-3">
							<div class="feature">
								<span><i style="color: #fff;" class="fa fa-newspaper-o fa-2x"></i></span>
								<h3 class="feature__title">Latest News</h3>
								<p class="feature__text">Click here to know the latest news about cars and vehicles. <br><a style="text-decoration: none;color: #659BDF;font-weight: bold;" href="{{ url('https://www.motor1.com/news/category/toys/') }}">Go to Website</a></p>
							</div>
						</div>

						<div class="col-12 col-md-6 col-lg-4 col-xl-3">
							<div class="feature">
								<span><i style="color: #fff;" class="fa fa-bars fa-2x"></i></span>
						...
						<div class="col-12 col-md-6 col-lg-4 col-xl-3">
							<div class="feature feature--last">
								<span><i style="color: #fff;" class="fa fa-exclamation-circle fa-2x"></i></span>
								<h3 class="feature__title">Product List</h3>
